...
{
    [SerializeField] private float acceleration, rotationVelocity, collisionForce, maxAngularSpeed, stopAngularVelocityTime, maxSpeed;
    public int damage = 0;
    ...
    [SerializeField] private GameObject deathScreen, panelUI;
